            ...
            <tbody>
                ...
                <?php 
                    while($dados = mysqli_fetch_assoc($resultado)){
                        ...
                        echo "<td><a class='btn btn-sm btn-danger' href='excluir_funcionario.php?id=$dados[id_funcionario]'> <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash-fill' viewBox='0 0 16 16'>
